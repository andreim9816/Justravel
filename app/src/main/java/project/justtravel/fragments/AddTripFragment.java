...
public class AddTripFragment extends Fragment {
    ...
    private static final int CITY_BREAK_TYPE = 0;
    private static final int SEASIDE_TYPE = 1;
    private static final int MOUNTAINS_TYPE = 2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        addTripButton.setOnClickListener(v -> {
            ...
            if (error) {
                ...
                try {
                    Date data = new SimpleDateFormat("dd/MM/yyyy").parse(startDateEditText.getText().toString());
                    Trip trip = new Trip(0,
                            nameEditText.getText().toString(),
                            destinationEditText.getText().toString(),
                            type,
                            (int) priceSlider.getValue(),
                            new SimpleDateFormat("dd/MM/yyyy").parse(startDateEditText.getText().toString()),
                            new SimpleDateFormat("dd/MM/yyyy").parse(endDateEditText.getText().toString()),
                            ratingBar.getRating()
                    );
    ...
    private static boolean checkFieldIsEmpty(EditText nameEditText, String error) {
