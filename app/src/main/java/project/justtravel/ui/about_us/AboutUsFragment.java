...
public class AboutUsFragment extends Fragment {
    ...
    private void setAboutUsText() {
        String aboutUsString = "    Just travel is a new, highly appreciated mobile app that allows the user to add, edit or see details about a trip. Developed in one week, " +
                ...
                "just to show how good he is at programming.";
